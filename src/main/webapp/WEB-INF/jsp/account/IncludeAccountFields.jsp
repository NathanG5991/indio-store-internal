...
<table>
	<tr>
        ...
        <tr>
	    <td>Catégorie favorite :</td>
            <td>
                <stripes:select name="account.favouriteCategoryId">
	            <stripes:option value="IT">INFORMATIQUE</stripes:option>
	            <stripes:option value="OFFICE">BUREAUTIQUE</stripes:option>
	            <stripes:option value="FURN">MOBILIER</stripes:option>
                    <stripes:option value="ELEC">ELECTRONIQUE</stripes:option>
                    <stripes:option value="COF">ESPACE CAFE</stripes:option>
                </stripes:select>
            </td>
        </tr>
