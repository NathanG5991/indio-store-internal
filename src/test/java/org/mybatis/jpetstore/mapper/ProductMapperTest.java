...
class ProductMapperTest {
  ...
  void getProductListByCategory() {
    ...
    assertThat(products.get(0).getDescription()).isEqualTo("Ordinateur portable haute performance pour développeur");
    ...
    assertThat(products.get(1).getDescription()).isEqualTo("Apple Silicon M3 - 16GB RAM");
    ...
    assertThat(products.get(2).getDescription()).isEqualTo("Dalle 4K pour graphistes et bureautique");
  }
  ...
  void searchProductList() {
    ...
    assertThat(products.get(0).getDescription()).isEqualTo("Pack de 50 capsules expresso");
